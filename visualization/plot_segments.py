...
class PlotSegments():
    ...
    def __init__(self, mapping_file, BAR_HEIGHT=50,  BAR_WIDTH = 640, WINDOW_HEIGH = 720, WINDOW_WIDTH = 1024):
    ...
    def plot_segment_bar(self):
        ...
        gt_img_bar, _, _ = self.create_segment_bar(self.gt_file)
        gt_img_bar = cv2.resize(gt_img_bar, (self.VIDEO_WIDTH, self.BAR_HEIGHT))  # Modify this line
        ...
        pred_img_bar, _, _ = self.create_segment_bar(self.pred_file)
        pred_img_bar = cv2.resize(pred_img_bar, (self.VIDEO_WIDTH, self.BAR_HEIGHT))  # Modify this line
    ...
    def plot_playing_progress(self, width = 2,  height=110):
        ...
        #print('Frame:', nextFrameNo, 'Total:', totalFrames)
    ...
    def show_other_info(self, acc=0.0, edit=0.0, f150=0.0 ):
        ...
        print('Duration:', datetime.timedelta(seconds=seconds))
